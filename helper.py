...
def load_image(image_filename: str, mode: str = RGB_CODE) -> Image:
    ...
    :return: a multidimensional list representing the image in the format
...
def load_lists(image: PILImage) -> Image:
    """
    Converts an Image object to an image represented as RGB lists.
    :param image: a PIL Image object
    :return: the same image represented as multidimensional list.
    """
...
def show_image(image: Image) -> None:
    """
    Displays an image.
    :param image: an image represented as a multidimensional list of the
...
def save_image(image: Image, filename: str) -> None:
    ...
    :param image: an image represented as a multidimensional list.
...
def __pil_image_from_lists(image_as_lists: Image) -> PILImage:
    ...
    :param image_as_lists: an image represented as multidimensional list.
